...
pub fn main() {
    ...
    let geode_1 = recurse(&blueprints[0], (0, 1, 0, 0, 0, 0, 0, 0), 32);
    let geode_2 = recurse(&blueprints[1], (0, 1, 0, 0, 0, 0, 0, 0), 32);
    let geode_3 = recurse(&blueprints[2], (0, 1, 0, 0, 0, 0, 0, 0), 32);

    println!("{}", geode_1 * geode_2 * geode_3);
}
